<%
  ...
  strMailAddress = "218.75.111.73"
  	'将所有信息加到主内容里
	 strContent=""
	 strContent=strContent&"公司名字:"& Request("Company")& vbCrlf
	 strContent=strContent&"公司地址:"&Request("Address")&Request("ZipCode")& VBCrlf
	 ...
	 strContent=strContent&"公司网站:"&Request("homepage")& VBCrlf
  ...
  Sub SendAction(subject, mailaddress, email, sender, content, fromer)
	...
	JMail.From = "web@cnhuana.net "
	JMail.MailServerUserName = "web@cnhuana.net"
	JMail.MailServerPassWord = "web456"
	...
	if err<>0 then
	 		Response.Write "<script language=JavaScript1.1>alert('发生错误:"& CStr(Err.Number) & " 原因是: " & Err.Description&"'); "
