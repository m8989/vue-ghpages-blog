...
<form name="form1" method="post" action="../admin/login1.asp" style="line-height:2.7em">
    <table width="100%" border="0" align="center">
      ...
      <tr>
        <td align="right"><input id="submit12" style="WIDTH: 64px; HEIGHT: 24px" type="submit" size="21" value="login" name="submit1">
        </td>
        <td>&nbsp; 
          <input id="reset" style="WIDTH: 57px; HEIGHT: 24px" type="reset" size="28" value="reset" name="reset1"></td>
      </tr>
    </table>
</form> 
<%
...
<table width="130" border="0" align="center" cellspacing="0">
  ...
  <tr>
    <td colspan="2" align="center"><a href="<%=This_Site_Path%>/product/product_manage.asp">管理商品</a></td>
  </tr>
</table>
<%
end if
