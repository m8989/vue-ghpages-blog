...
<table width="90%" border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#CBCBCB">
		  <!--tr bgcolor="#B9D5F2"> 
                  ...
                  <tr> 
                    <td height="20" width="20"  align=left bgcolor="#FFFFFF"><img src="../images/ball4.gif"></td>
                    <td  align=left bgcolor="#FFFFFF">&nbsp;&nbsp;<a href="../news/e_show.asp?newsID=<% =rs("newsID") %>"> 
                      <% =HtmlOut(rs("n_Title")) %>
                    </a></td>
...
i=i+1 %>
                  <tr> 
                    <td height="20" width="20"  align=left bgcolor="#F9F8FD"><img src="../images/ball4.gif"></td>
                    <td  align=left bgcolor="#F9F8FD">&nbsp;&nbsp;<a href="../news/e_show.asp?newsID=<% =rs("newsID") %>"> 
                      <% =HtmlOut(rs("n_Title")) %>
                    </a></td>
...
<table width="90%" border="0" cellspacing="2" cellpadding="0" align="center">   
  <tr>    
    <td>【 total of <font color="#FF0000"> <%=result_num %> </font>pieces of merchandise found】</td>   
