...
<table width="95%"  border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td width="189"><div align="center"><a href="../product/product_show.asp?pID=<%=HtmlOut(rs("Pid")) %>"><img src="<%=HtmlOut(rs("P_picpath")) %>" onload="reloadImg(this,189,275)" border=0 /></a></div></td>
  </tr>
  <tr>
    <td width="189"><div align="center"><a href="../product/product_show.asp?pID=<%=HtmlOut(rs("Pid")) %>"><span class="unnamed1">『<%=HtmlOut(rs("p_Name")) %>』</span></a></div></td>
  </tr>
  <tr>
    <td width="189"><div align="center"><a href="../product/product_show.asp?pID=<%=HtmlOut(rs("Pid")) %>"><span class="unnamed1">『<%=HtmlOut(rs("p_Area")) %>』</span></a></div></td>
  </tr>
</table>
                      </td>
                    <%if i mod 3 =0 then%>
